...
function validateInputPrivKey() {
    ...
    if (isValidPrivKey(privKeyInput)) {
        ...
        output = addr + "<i><br>- View on <a href=\"https://counterpartychain.io/address/"+addr+"\"  target=\"_blank\">CounterpartyChain</a><br>- View on <a href=\"http://blockscan.com/address/"+addr+"\"  target=\"_blank\">Blockscan</a><br>- View on <a href=\"https://www.blocktrail.com/BTC/address/"+addr+"\"  target=\"_blank\">Blocktrail</a><br>- View on <a href=\"https://blockchain.info/address/"+addr+"\"  target=\"_blank\">Blockchain.info</a></i>";
    } else {
